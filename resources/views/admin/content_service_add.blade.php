<div class="wrapper container-fluid">
	...
	<div class="form-group">
		...
		<div class="col-xs-8">
			{!! Form::text('name',old('name'),['class' => 'form-control','placeholder'=>'Введите название сревиса'])!!}
		</div>
	...
	<div class="form-group">
	     ...
	     <div class="col-xs-8">
		 	{!! Form::text('icon', old('icon'), ['class' => 'form-control','placeholder'=>'Введите имя иконки: fa-star']) !!}
		 </div>
    </div>
